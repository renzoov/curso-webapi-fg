        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalaDeCine>()
                .HasData(new List<SalaDeCine>
                {
                    ...
                    new SalaDeCine{Id = 5, Nombre = "Megacentro", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-69.859358, 18.506934))},
            ...
            var animacion = new Genero() { Id = 5, Nombre = "Animación" };
            var suspenso = new Genero() { Id = 6, Nombre = "Suspenso" };
            var romance = new Genero() { Id = 7, Nombre = "Romance" };

            modelBuilder.Entity<Genero>().HasData(new List<Genero> { aventura, animacion, suspenso, romance });

            var jimCarrey = new Actor() { Id = 5, Nombre = "Jim Carrey", FechaNacimiento = new DateTime(1962, 1, 17) };
            var robertDowney = new Actor() { Id = 6, Nombre = "Robert Downey Jr.", FechaNacimiento = new DateTime(1965, 4, 4) };
            var chrisEvans = new Actor() { Id = 7, Nombre = "Chris Evans", FechaNacimiento = new DateTime(1981, 6, 13) };
            ...
            var iw = new Pelicula()
            {
                ...
                EnCines = false,
                FechaEstreno = new DateTime(2018, 04, 26)
            };
            ...
            var sonic = new Pelicula()
            {
                ...
                EnCines = false,
                FechaEstreno = new DateTime(2020, 02, 14)
            };
            ...
            modelBuilder.Entity<Pelicula>().HasData(new List<Pelicula> { endgame, iw, sonic, emma, wonderwoman });
